export default {
  ...
  home: {
    ...
    heroSubtitle: 'High-quality AI access service: stable, secure, low-latency',
    heroDescription: 'One key connects multiple intelligent capabilities with unified auth, billing, routing, and team usage management',
    tags: {
      subscriptionToApi: 'High-Quality Service',
    ...
    features: {
      unifiedGateway: 'High-Quality Access',
      unifiedGatewayDesc: 'Use one API entry point and key system to quickly access text, code, image, and other intelligent capabilities.',
      multiAccount: 'Stable and Reliable',
      multiAccountDesc: 'Smartly routes available resources with automatic failover and load balancing to reduce interruptions and failed requests.',
      balanceQuota: 'Transparent Control',
      balanceQuotaDesc: 'Usage-based billing with quotas, concurrency controls, and team permission management.'
    },
    // Comparison section
    comparison: {
      title: 'Why Choose Us?',
      ...
      items: {
        ...
        models: {
          ...
          us: 'Unified access to multiple intelligent capabilities'
        },
        management: {
    ...
    providers: {
      ...
      description: 'High-quality, stable, controllable intelligent interface services for teams and enterprises',
      supported: 'Supported',
      soon: 'Soon',
      ...
      claude: 'Intelligent Text',
      gemini: 'Vision Understanding',
      antigravity: 'Code Assistance',
      more: 'More'
    },
    // CTA section
    cta: {
      title: 'Ready to Get Started?',
      description: 'Sign up to experience high-quality, stable, transparent, controllable AI services',
      button: 'Sign Up Free'
    },
    footer: {
  ...
  // Setup Wizard
  setup: {
    title: 'EntanglementAI Setup',
    description: 'Configure your EntanglementAI instance',
    database: {
  ...
  keys: {
    ...
    quotaAmount: 'Quota Amount (Yuan)',
    quotaAmountPlaceholder: 'Enter quota limit in yuan',
    ...
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (Yuan)',
    rateLimit1d: 'Daily Limit (Yuan)',
    rateLimit7d: '7-Day Limit (Yuan)',
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for EntanglementAI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for EntanglementAI end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'EntanglementAI',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'High-quality AI API gateway platform',
      ...
      payment: {
        ...
        alipayConfigGuideTitle: 'Configuration Parameters Guide',
        alipayConfigGuideAppIdLabel: 'App ID (Application ID / APPID)',
        alipayConfigGuideAppIdHint: 'Obtained after creating an application on Alipay Open Platform (open.alipay.com), format: 2021xxxxxxxxxxxxx',
        alipayConfigGuidePrivateKeyLabel: 'Application Private Key (privateKey)',
        alipayConfigGuidePrivateKeyHint: 'Generate RSA2(SHA256) key pair using Alipay key generation tool, upload public key to Alipay dashboard, keep private key here. Format: complete PKCS#1 or PKCS#8 private key string (including BEGIN/END markers)',
        alipayConfigGuidePublicKeyLabel: 'Alipay Public Key (publicKey / alipayPublicKey)',
        alipayConfigGuidePublicKeyHint: 'In Alipay Open Platform → App Details → Development Info → Interface Signing Method, after uploading app public key, click "View Alipay Public Key". Note: This is NOT your app public key, but the public key returned by Alipay platform',
        alipayConfigGuideMerchantTypeTitle: 'Merchant Type Description',
        alipayConfigGuideMerchantTypeIndividual: 'Individual Business: Requires business license, legal person ID, settlement bank card. Can activate Face-to-Face, Mobile Website Payment, Desktop Website Payment',
        alipayConfigGuideMerchantTypeEnterprise: 'Enterprise Merchant: Requires business license, corporate account info. Can activate all payment products',
        alipayConfigGuideMerchantTypePersonal: 'Individual Developer: Supports mini-programs, lifestyle accounts, but NOT payment collection products like Face-to-Face',
        alipayConfigGuideStepsTitle: 'Configuration Steps (Individual Business / Enterprise)',
        alipayConfigGuideStep1: '1. Login to Alipay Open Platform (open.alipay.com) with merchant Alipay account',
        alipayConfigGuideStep2: '2. Create Application: Console → Web & Mobile App → Create App, fill in app information',
        alipayConfigGuideStep3: '3. Configure Keys: Download "Alipay Open Platform Key Tool", generate RSA2(SHA256) key pair',
        alipayConfigGuideStep4: '4. Upload Public Key: App Details → Development Info → Interface Signing Method → Settings → Upload App Public Key',
        alipayConfigGuideStep5: '5. Get Parameters: Record APPID, save app private key, click "View Alipay Public Key" to get Alipay public key',
        alipayConfigGuideStep6: '6. Sign Products: App Details → Product Binding → Add Product (Face-to-Face / Mobile Website Payment / Desktop Website Payment)',
        alipayConfigGuideStep7: '7. Submit for Review: Submit business license and qualification materials based on merchant type, wait for approval',
        alipayConfigGuideDocsLink: 'Documentation: https://opendocs.alipay.com/open/291/105971',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'EntanglementAI',
        useTls: 'Use TLS',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to EntanglementAI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">EntanglementAI is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of EntanglementAI, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to EntanglementAI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the EntanglementAI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Displayed equivalently: pay 1 CNY, balance shows {cny}',
  ...
  public: {
    about: {
      ...
      registrationNumber: 'Registration Number / Credit Code',
      ...
      icpInfo: 'ICP Filing Information',
