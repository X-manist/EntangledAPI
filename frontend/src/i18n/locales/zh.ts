export default {
  ...
  home: {
    ...
    goToDashboard: '进入控制台',
    // 新增：面向用户的价值主张
    heroSubtitle: '高质量 AI 接入服务，稳定、安全、低延迟',
    heroDescription: '一个密钥即可接入多种智能能力，统一鉴权、计费、调度与团队用量管理',
    tags: {
      subscriptionToApi: '高质量服务',
      stickySession: '稳定路由',
    ...
    features: {
      unifiedGateway: '高质量接入',
      unifiedGatewayDesc: '统一 API 入口与密钥体系，快速接入文本、代码、图片等智能能力。',
      multiAccount: '稳定可靠',
      multiAccountDesc: '智能调度可用资源，自动切换和负载均衡，减少中断与失败请求。',
      balanceQuota: '透明可控',
      balanceQuotaDesc: '按实际使用量计费，支持额度、并发和团队成员权限管理。'
    },
    // 优势对比
    comparison: {
      title: '为什么选择我们？',
    ...
    providers: {
      title: '核心服务能力',
      description: '为企业和团队提供高质量、稳定、可管控的智能接口服务',
      supported: '已支持',
      soon: '即将推出',
      text: '智能文本',
      coding: '代码辅助',
    ...
    cta: {
      title: '准备好开始了吗？',
      description: '注册即可体验高质量、稳定、透明可控的一站式 AI 服务',
      button: '免费注册'
    },
    footer: {
  ...
  keys: {
    ...
    quotaLimit: '额度限制',
    quotaAmount: '额度金额（元）',
    quotaAmountPlaceholder: '输入元额度限制',
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于纠缠智能用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于纠缠智能用户登录',
      ...
      site: {
        ...
        siteNamePlaceholder: '纠缠智能',
        siteSubtitle: '站点副标题',
        siteSubtitleHint: '显示在登录和注册页面',
        siteSubtitlePlaceholder: '高质量 AI 接入服务，稳定、安全、低延迟',
        apiBaseUrl: 'API 端点地址',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用纠缠智能',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">纠缠智能是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是纠缠智能的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用纠缠智能',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到纠缠智能 AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: '按等价人民币展示：支付 1 元，余额显示为 {cny}',
    refundReason: '退款原因',
