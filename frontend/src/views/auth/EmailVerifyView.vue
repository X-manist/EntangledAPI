...
import { defaultBrandName, resolveDisplayBrandName } from '@/utils/branding'
...
const siteName = ref<string>(defaultBrandName(locale.value))
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = resolveDisplayBrandName(settings.site_name, locale.value)
