...
function formatCreditedAmount(paymentOrder: PaymentOrder): string {
  if (paymentOrder.order_type === 'balance') {
    return formatBackendUserAmount(paymentOrder.amount, 2)
  }
  return formatPaymentAmount(paymentOrder.amount, paymentOrder.currency || currency.value, localeCode.value)
}
