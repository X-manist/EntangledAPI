...
import { BRAND_NAME_EN, resolveDisplayBrandName } from '@/utils/branding'
import {
...
export const useAppStore = defineStore('app', () => {
  ...
  const siteName = ref<string>(BRAND_NAME_EN)
  ...
  function applySettings(config: PublicSettings): void {
    ...
    siteName.value = resolveDisplayBrandName(config.site_name, i18n.global.locale.value)
  ...
  function applyLocaleBrand(locale?: string | null): void {
    siteName.value = resolveDisplayBrandName(cachedPublicSettings.value?.site_name || siteName.value, locale)
  }
  ...
  async function fetchPublicSettings(force = false): Promise<PublicSettings | null> {
    ...
    if (publicSettingsLoaded.value && !force) {
      ...
      return {
        ...
        turnstile_site_key: '',
        site_name: resolveDisplayBrandName(siteName.value, i18n.global.locale.value),
