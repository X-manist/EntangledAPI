<template>
  <div ref="rootRef" v-if="showUsageWindows">
    ...
    <!-- OpenAI-compatible OAuth accounts: single source from /usage API -->
    <template v-else-if="(account.platform === 'openai' || account.platform === 'github-copilot') && account.type === 'oauth'">
...
const shouldFetchUsage = computed(() => {
  ...
  if (props.account.platform === 'openai' || props.account.platform === 'github-copilot') {
    return props.account.type === 'oauth'
  }
  return false
})
...
const hasOpenAIUsageFallback = computed(() => {
  if ((props.account.platform !== 'openai' && props.account.platform !== 'github-copilot') || props.account.type !== 'oauth') return false
...
watch(openAIUsageRefreshKey, (nextKey, prevKey) => {
  ...
  if ((props.account.platform !== 'openai' && props.account.platform !== 'github-copilot') || props.account.type !== 'oauth') return
