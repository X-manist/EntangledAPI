...
export type GroupPlatform = 'anthropic' | 'openai' | 'github-copilot' | 'gemini' | 'antigravity'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'github-copilot' | 'gemini' | 'antigravity'
