...
export type Platform = 'anthropic' | 'openai' | 'github-copilot' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  'github-copilot': 'bg-slate-500/10 text-slate-700 border-slate-500/30 dark:text-slate-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  'github-copilot': 'bg-slate-500/10 text-slate-700 dark:bg-slate-500/10 dark:text-slate-300',
...
const BORDER: Record<Platform, string> = {
  ...
  'github-copilot': 'border-slate-500/20 dark:border-slate-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  'github-copilot': 'bg-gradient-to-r from-slate-400 to-slate-500',
...
const TEXT: Record<Platform, string> = {
  ...
  'github-copilot': 'text-slate-700 dark:text-slate-300',
...
const ICON: Record<Platform, string> = {
  ...
  'github-copilot': 'text-slate-600 dark:text-slate-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  'github-copilot': 'bg-slate-700 text-white hover:bg-slate-800 active:bg-slate-900 dark:bg-slate-700/80 dark:hover:bg-slate-700',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  'github-copilot': 'bg-slate-100 text-slate-700 dark:bg-slate-800/60 dark:text-slate-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  'github-copilot': 'from-slate-600 to-slate-700',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'github-copilot' || p === 'antigravity' || p === 'gemini'
}
