...
func HasConversations() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasConversationsWith(preds ...predicate.Conversation) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
...
// HasKnowledgeFiles applies the HasEdge predicate on the "knowledge_files" edge.
func HasKnowledgeFiles() predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasKnowledgeFilesWith applies the HasEdge predicate on the "knowledge_files" edge with a given conditions (other predicates).
func HasKnowledgeFilesWith(preds ...predicate.KnowledgeFile) predicate.Workspace {
	return predicate.Workspace(func(s *sql.Selector) {
		step := newKnowledgeFilesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
