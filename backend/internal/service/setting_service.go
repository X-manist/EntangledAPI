...
const (
	defaultSiteName = "EntanglementAI"
...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         normalizeSiteName(settings[SettingKeySiteName], nil),
...
func (s *SettingService) GetSiteName(ctx context.Context) string {
	...
	return normalizeSiteName(value, err)
}
...
func normalizeSiteName(value string, err error) string {
	name := strings.TrimSpace(value)
	if err != nil || name == "" || strings.EqualFold(name, legacySiteName) {
