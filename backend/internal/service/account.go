...
func (a *Account) IsGitHubCopilot() bool {
	return a.Platform == PlatformGitHubCopilot
}

func (a *Account) IsOpenAICompatible() bool {
	return a.IsOpenAI() || a.IsGitHubCopilot()
}
...
func (a *Account) IsGitHubCopilotOAuth() bool {
	return a.IsGitHubCopilot() && a.Type == AccountTypeOAuth
}

func (a *Account) IsGitHubCopilotAPIKey() bool {
	return a.IsGitHubCopilot() && a.Type == AccountTypeAPIKey
}
...
func (a *Account) GetGitHubCopilotBaseURL() string {
...
func (a *Account) GetGitHubCopilotAccessToken() string {
	if !a.IsGitHubCopilotOAuth() {
		return ""
	}
	return a.GetCredential("access_token")
}

func (a *Account) GetGitHubCopilotGitHubToken() string {
	if !a.IsGitHubCopilotOAuth() {
		return ""
	}
...
func (a *Account) GetGitHubCopilotAPIKey() string {
	if !a.IsGitHubCopilotAPIKey() {
		return ""
	}
	return a.GetCredential("api_key")
}
...
func (a *Account) GetGitHubCopilotTokenExpiresAt() *time.Time {
	if !a.IsGitHubCopilotOAuth() {
		return nil
	}
	return a.GetCredentialAsTime("expires_at")
...
func (a *Account) IsGitHubCopilotTokenExpired() bool {
	expiresAt := a.GetGitHubCopilotTokenExpiresAt()
	if expiresAt == nil {
		return false
	}
	return time.Now().Add(60 * time.Second).After(*expiresAt)
