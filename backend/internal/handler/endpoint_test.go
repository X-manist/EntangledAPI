...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		// GitHub Copilot — always /v1/chat/completions.
		{"copilot from messages", EndpointMessages, "/v1/messages", service.PlatformGitHubCopilot, EndpointChatCompletions},
		{"copilot from completions", EndpointChatCompletions, "/v1/chat/completions", service.PlatformGitHubCopilot, EndpointChatCompletions},
		{"copilot from responses", EndpointResponses, "/v1/responses", service.PlatformGitHubCopilot, EndpointChatCompletions},
