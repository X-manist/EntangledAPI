...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	gitHubCopilotOAuthService := service.NewGitHubCopilotOAuthService(settingService, proxyRepository, httpUpstream)
	...
	accountHandler := admin.NewAccountHandlerWithGitHubCopilotOAuth(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, gitHubCopilotOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator)
