...
# 安全说明：本仓库不会内置该 OAuth client，请在运行环境通过环境变量注入。
...
> **Note:** Code Assist OAuth can use the Gemini CLI client, but this deployment must provide that client ID and secret through environment variables.
